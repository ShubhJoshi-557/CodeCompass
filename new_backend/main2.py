...
def load_repo_index(repo_key):
    ...
    with open(metadata_file, "rb") as f:
        ...
        # The new metadata mapping is stored under the key "vector_id_to_chunk"
...
class CodeCompassIndexer:
    ...
    def update_index(self, current_chunks, get_embedding):
        ...
        if new_chunks:
            ...
            new_vectors = []
            new_ids = []
            # Determine the next available vector ID
...
class SearchQuery(BaseModel):
    query: str
    repo_owner: str = None      # Repository owner
    repo_name: str = None       # Repository name
    branch: str = None          # Branch (optional)
    folder: str = None
    filters: dict = {}
